...
export default function Component({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "min-h-screen w-full flex items-center justify-center px-4 py-16 text-zinc-50 font-inter relative overflow-hidden",
        className
      )}
    >
      <div className="absolute inset-0 -z-10">
        <div className="absolute -top-32 -left-32 w-[500px] h-[500px] bg-gradient-to-tr from-cyan-500 via-purple-500 to-indigo-500 opacity-20 rounded-full blur-3xl animate-pulse-slow z-0" />
        <motion.div
          animate={{
            rotate: [0, 360],
          }}
